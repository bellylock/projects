(function($) {
    ...
    $pc.fn.extend({
        build: function() {
            ...
            this.textPrev = $("<a class='previous'>" + this.options.text.previous + "</a>").insertAfter(this.aniWrap);
            this.textNext = $("<a class='next'>" + this.options.text.next + "</a>").insertAfter(this.aniWrap);
            ...
            if (this.options.carousel && $.fn.jcarousel) {
                ...
                var carouselOptions = $.extend({},
                    carouselDefaults, this.options.carouselOptions || {});
        ...
        doAnimation: function(n, data) {
            ...
            switch (n) {
                case 0:
                    self.image.stop(true, true).fadeOut(self.options.animationSpeed,
                        function() {
                            self.image.attr('src', data.source).fadeIn(self.options.animationSpeed,
                                function() {
                ...
                case 3:
                    self.aniDiv.show().children("div:lt(5)").hide().each(function(index) {
                        ...
                        $(this).css({
                            ...
                            self.options.animationSpeed, 'linear',
                            function() {
