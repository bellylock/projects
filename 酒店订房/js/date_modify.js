    ...
    var calendarSwitch = (function() {
        ...
        calendarSwitch.prototype = { /*说明：初始化插件*/
            ...
            init: function() {
                ...
                var html = "<div class='headerWrapper'><div class='comfire'>完成</div></div><table class='dateZone'><tr><td class='colo'>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td class='colo'>六</td></tr></table>" + "<div class='tbody'></div>"
//              var html = "<div class='headerWrapper'><div class='comfire'>完成</div></div><table class='dateZone'><tr><td class='colo'>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td class='colo'>六</td></tr></table>" + "<div class='tbody'></div>"
...
//                         $(me.sections).find('.ny1').eq(select).text(currentYear + '年'  + yf + '月');
                        $(me.sections).find('.ny1').eq(select).text(yf + '月');
                    } else {
//                         $(me.sections).find('.ny1').eq(select).text(currentYear + '年' + yf + '月');
                        $(me.sections).find('.ny1').eq(select).text(yf + '月');
                    }
                        ...
                        if ($(this).text() == '离店') {
                            ...
                            $(me.sections).find('.tbody .rz').each(function(index, element) {
                                if ($(this).text() == '入住') {
                                    ...
                                    //添加入住到input
                                    $('#startDate').val(startDayYear + startDayMonth + day + '日');
                                ...
                                if ($(this).text() == '离店') {
                                    ...
                                    //添加入住到input
                                    $('#endDate').val(endDayYear + endDayMonth  + day + '日');
