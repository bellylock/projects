        ...
        function init() {
            ...
            if ( settings.enableTouch && _flipItems.length > 1 ) {
                _flipster.on("touchstart.flipster", function(e) {
                    ...
                    _startTouchY = e.originalEvent.targetTouches[0].screenY;
                });

                _flipster.on("touchmove.flipster", function(e) {
                    e.preventDefault();
                    var nowX = e.originalEvent.targetTouches[0].screenX;
                    var nowY = e.originalEvent.targetTouches[0].screenY;
                    var up_and_down = nowY -_startTouchY;
                    ...
                    if(up_and_down > _flipItems[0].clientHeight/4){
                        var scrollH = $(document).scrollTop();
                        $(document).scrollTop(scrollH - up_and_down + 20);
                        console.log("向下");
                        
                    }else if( up_and_down < -1*(_flipItems[0].clientHeight/4)){
                        var scrollH = $(document).scrollTop();
                        $(document).scrollTop(scrollH - up_and_down - 20);
                        console.log("向上");
                    }
